...
<body>
    ...
    <form  name="form1" action="addNewDonorAction.jsp" method="post">

<center>
<table cellpadding="12">

<tr>
    <th><h1>Donor Details</h1></th>
</tr>
...
<tr>
<td>Enter Email</td>
<td><input type="text" placeholder="E-mail" class="A" name="u4"></td>
</tr>

<tr>
<td>Contact Number:</td>
<td><input type="text" placeholder="Contact" class="A" id="t2" name="u5"><br>
    <font id="s2"></font>
</td>
</tr>
...
<tr>
<td>Address:</td>
<td><input type="text" placeholder="Address" class="A" id="t3"name="u6"><br>
<font id="s3"></font>
</td>
</tr>
...
<tr>
<th colspan="2" style="font-size:80px">  <button  class="B" onclick="demo(event)" >SAVE</button></th>
